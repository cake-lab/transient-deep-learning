...
@registry.register_hparams
def resnet_cifar_32_vanilla():
  hp = resnet_cifar_15()
  hp.layer_sizes = [5, 5, 5]
  hp.learning_rate = 0.1
  hp.learning_rate_decay_scheme = "piecewise"
  hp.add_hparam("learning_rate_boundaries", [32000, 48000])
  hp.add_hparam("learning_rate_multiples", [0.1, 0.01])
  hp.optimizer_momentum_nesterov = False
  return hp
